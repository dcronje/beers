...
class RegionType extends GraphQLType
{
    ...
    {
        return CityHelper::allCitiesResolver($root, $args, ['_regionId', '=', $root['_id']]);
    }

    protected function resolveOneCityField($root, $args)
    {
        return CityHelper::oneCityResolver($root, $args, ['_regionId', '=', $root['_id']]);
    }

    protected function resolveCityCountField($root, $args)
    {
        return CityHelper::cityCountResolver($root, $args, ['_regionId', '=', $root['_id']]);
    }
