...
class AreaType extends GraphQLType
{
    ...
    {
        return LocationHelper::allLocationsResolver($root, $args, ['_areaId', '=', $root['_id']]);
    }

    protected function resolveOneLocationField($root, $args)
    {
        return LocationHelper::oneLocationResolver($root, $args, ['_areaId', '=', $root['_id']]);
    }

    protected function resolveLocationCountField($root, $args)
    {
        return LocationHelper::locationCountResolver($root, $args, ['_areaId', '=', $root['_id']]);
    }
