...
class LocationType extends GraphQLType
{
    ...
    {
        return Area::where('_id', '=', $root['_areaId'])->first();
    }

    public function resolveCityField($root, $args)
    {
        return City::where('_id', '=', $root['_cityId'])->first();
    }

    public function resolveRegionField($root, $args)
    {
        return Region::where('_id', '=', $root['_regionId'])->first();
    }

    public function resolveCountryField($root, $args)
    {
        return Country::where('_id', '=', $root['_countryId'])->first();
    }
