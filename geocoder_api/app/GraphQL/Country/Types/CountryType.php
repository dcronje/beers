...
class CountryType extends GraphQLType
{
    ...
    {
        return RegionHelper::allRegionsResolver($root, $args, ['_countryId', '=', $root['_id']]);
    }

    protected function resolveOneRegionField($root, $args)
    {
        return RegionHelper::oneRegionResolver($root, $args, ['_countryId', '=', $root['_id']]);
    }

    protected function resolveRegionCountField($root, $args)
    {
        return RegionHelper::regionCountResolver($root, $args, ['_countryId', '=', $root['_id']]);
    }
