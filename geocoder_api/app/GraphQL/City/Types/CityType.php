...
class CityType extends GraphQLType
{
    ...
    {
        return AreaHelper::allAreasResolver($root, $args, ['_cityId', '=', $root['_id']]);
    }

    protected function resolveOneAreaField($root, $args)
    {
        return AreaHelper::oneAreaResolver($root, $args, ['_cityId', '=', $root['_id']]);
    }

    protected function resolveAreaCountField($root, $args)
    {
        return AreaHelper::areaCountResolver($root, $args, ['_cityId', '=', $root['_id']]);
    }
